...
class ShowingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create showing" do
    assert_difference('Showing.count') do
      post showings_url, params: { showing: { auditorium_id: @showing.auditorium_id, avail_seats: @showing.avail_seats, date: @showing.date, movie_id: @showing.movie_id, showtime: @showing.showtime } }
    end
  ...
  test "should update showing" do
    patch showing_url(@showing), params: { showing: { auditorium_id: @showing.auditorium_id, avail_seats: @showing.avail_seats, date: @showing.date, movie_id: @showing.movie_id, showtime: @showing.showtime } }
